...
import { a as adminListContactMessages, b as adminUpdateContactMessage } from "./enrollments.functions-DVdkOzpD.mjs";
...
import { l as LoaderCircle, I as ArrowLeft, y as Mail, aF as MailOpen, aG as CheckCheck, at as Trash2 } from "../_libs/lucide-react.mjs";
...
function ContactMessagesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-6 pt-28 pb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-4 font-display text-3xl font-bold flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-7 w-7 text-primary-glow" }),
        "Contact ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Messages" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Messages submitted from the public contact form." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 space-y-3", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-3d rounded-2xl p-10 text-center text-muted-foreground", children: "No messages yet." }) : items.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `card-3d rounded-2xl p-5 ${m.status === "new" ? "border-l-4 border-primary" : ""}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground", children: new Date(m.created_at).toLocaleString() })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `rounded-full px-2 py-0.5 text-xs ${m.status === "new" ? "bg-primary/15 text-primary-glow" : m.status === "read" ? "bg-amber-500/15 text-amber-400" : "bg-muted/30 text-muted-foreground"}`, children: m.status })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 whitespace-pre-wrap text-sm", children: m.message }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-wrap gap-2", children: [
          m.status !== "read" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: () => update.mutate({
            id: m.id,
            status: "read"
          }), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MailOpen, { className: "h-3 w-3" }),
            " Mark read"
          ] }),
          m.status !== "replied" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: () => update.mutate({
            id: m.id,
            status: "replied"
          }), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${m.email}?subject=Re: your message to Vyombotics`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-3 w-3" }),
            " Reply"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", onClick: () => {
            if (confirm("Delete this message?")) update.mutate({
              id: m.id,
              delete: true
            });
...
export {
  ContactMessagesPage as component
};

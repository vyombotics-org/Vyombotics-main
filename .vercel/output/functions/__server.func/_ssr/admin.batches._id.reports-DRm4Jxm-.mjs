...
import { l as listBatchStudentsForReports } from "./reports.functions-DQZTgWvh.mjs";
import { o as Route$5 } from "./router-8ViFXMOq.mjs";
...
import { I as ArrowLeft, aL as FileChartColumnIncreasing, l as LoaderCircle } from "../_libs/lucide-react.mjs";
...
function BatchReports() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-6 pt-28 pb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-4 font-display text-3xl font-bold flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileChartColumnIncreasing, { className: "h-7 w-7 text-primary-glow" }),
        " Student Reports"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Generate a detailed progress report for any enrolled student." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 card-3d rounded-2xl p-3", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid place-items-center py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin text-primary" }) }) : (data?.students ?? []).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "py-10 text-center text-sm text-muted-foreground", children: "No enrolled students yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-border/40", children: (data?.students ?? []).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center justify-between gap-3 p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-8 w-8 place-items-center rounded-full bg-[image:var(--gradient-primary)] text-xs font-bold text-background", children: (s.full_name || "?").slice(0, 1).toUpperCase() }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: s.full_name || "—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", variant: "outline", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/reports/$batchId/$userId", params: {
          batchId: id,
          userId: s.id

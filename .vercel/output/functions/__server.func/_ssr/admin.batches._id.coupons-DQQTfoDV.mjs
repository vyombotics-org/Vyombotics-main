...
import { a as listCouponsForBatch, u as upsertCoupon, d as deleteCoupon } from "./coupons.functions-CHQDJQuj.mjs";
import { r as Route$2 } from "./router-8ViFXMOq.mjs";
...
import { l as LoaderCircle, I as ArrowLeft, ai as Tag, az as Plus, X, aE as Percent, al as IndianRupee, ay as Save, aD as Pencil, at as Trash2 } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-6 pt-28 pb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Promo codes that apply only to this batch." })
        ] }),
        !form && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "btn-glow", onClick: () => setForm(empty()), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-2 h-4 w-4" }),
          " New coupon"
        ] })
      ] }),
      form && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 card-3d rounded-2xl border border-border/40 bg-card/40 p-6 backdrop-blur-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold", children: form.id ? "Edit coupon" : "New coupon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => setForm(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-4 w-4" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.discount_type, onValueChange: (v) => setForm({
              ...form,
              discount_type: v
            }), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: "percent", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Percent, { className: "mr-2 inline h-3 w-3" }),
                  " Percent"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: "flat", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "mr-2 inline h-3 w-3" }),
                  " Flat ₹"
                ] })
              ] })
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 flex items-center gap-3 rounded-lg border border-border/40 p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { checked: form.is_active, onCheckedChange: (v) => setForm({
              ...form,
              is_active: v
            }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: form.is_active ? "Active" : "Disabled" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "btn-glow", onClick: () => save.mutate(form), disabled: save.isPending, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 card-3d rounded-2xl overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-[640px] text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-card/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 font-medium", children: "Code" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 font-medium", children: "Discount" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 font-medium", children: "Used" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 font-medium", children: "Validity" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: coupons.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, className: "px-4 py-10 text-center text-muted-foreground", children: "No coupons yet for this batch." }) }) : coupons.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-border/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono font-semibold", children: c.code }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3", children: c.discount_type === "percent" ? `${c.discount_value}%` : `₹${c.discount_value}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-3 text-muted-foreground", children: [
            c.used_count,
            c.max_uses ? ` / ${c.max_uses}` : ""
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-3 text-xs text-muted-foreground", children: [
            c.valid_from ? new Date(c.valid_from).toLocaleDateString() : "—",
            " →",
            " ",
            c.valid_until ? new Date(c.valid_until).toLocaleDateString() : "—"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `rounded-full px-2 py-0.5 text-xs ${c.is_active ? "bg-primary/15 text-primary-glow" : "bg-muted text-muted-foreground"}`, children: c.is_active ? "Active" : "Disabled" }) }),

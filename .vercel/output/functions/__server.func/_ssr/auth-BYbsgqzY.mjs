...
import { l as LoaderCircle, I as ArrowLeft, J as EyeOff, K as Eye, i as Check, X } from "../_libs/lucide-react.mjs";
...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center gap-2", "aria-label": "Vyombotics", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: vyomboticsLogo.url, alt: "Vyombotics Academy of Future Education", className: "h-12 w-auto" }) }) }),

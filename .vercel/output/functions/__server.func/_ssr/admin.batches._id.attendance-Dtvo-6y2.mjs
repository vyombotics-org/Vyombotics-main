...
import { b as getBatchAttendance, s as setAttendance } from "./learn.functions-DMFHKx5T.mjs";
import { s as Route$1 } from "./router-8ViFXMOq.mjs";
...
import { l as LoaderCircle, I as ArrowLeft } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 pt-28 pb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-4 font-display text-3xl font-bold", children: [
        "Attendance · ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: data?.batch?.name })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: data?.batch?.courses?.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: "Tap a cell to cycle: Present → Absent → Partial → Clear" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 card-3d rounded-2xl overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-[640px] text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-card/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-medium", children: "Student" }),
          lectures.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("th", { className: "px-3 py-3 text-center font-medium", title: l.title, children: [
            "#",
            l.order_index
          ] }, l.id)),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center font-medium", children: "%" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: students.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: lectures.length + 2, className: "px-4 py-10 text-center text-muted-foreground", children: "No paid students yet." }) }) : students.map((s) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-border/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: s.profiles?.full_name || s.user_id.slice(0, 8) }),
            lectures.map((l) => {
              const st = row[l.id] || "";
              const cls = st === "present" ? "bg-primary/20 text-primary-glow" : st === "partial" ? "bg-amber-500/15 text-amber-400" : st === "absent" ? "bg-destructive/15 text-destructive" : "bg-muted/30 text-muted-foreground";
              const next = cycle[st] ?? "present";
              return /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-2 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: mark.isPending, onClick: () => mark.mutate({
                lecture_id: l.id,
                user_id: s.user_id,
                status: next
              }), className: `inline-block min-w-8 rounded-md px-2 py-0.5 text-xs hover:opacity-80 ${cls}`, title: `Click to set: ${next}`, children: st ? st[0].toUpperCase() : "—" }) }, l.id);
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-center font-semibold gradient-text", children: [
              pct,
              "%"
            ] })
          ] }, s.user_id);

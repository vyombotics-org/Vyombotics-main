...
function requireNumericUnicodeMap() {
  ...
  numericUnicodeMap.numericUnicodeMap = void 0;
...
function requireSurrogatePairs() {
  ...
  surrogatePairs.highSurrogateTo = surrogatePairs.highSurrogateFrom = surrogatePairs.getCodePoint = surrogatePairs.fromCodePoint = void 0;
...
function requireCommonjs() {
  ...
  var __assign = commonjs && commonjs.__assign || function() {
    __assign = Object.assign || function(t) {
      for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
  ...
  commonjs.encode = encode;
  commonjs.decodeEntity = decodeEntity;
  commonjs.decode = decode;
  var named_references_js_1 = requireNamedReferences();
  var numeric_unicode_map_js_1 = requireNumericUnicodeMap();
  var surrogate_pairs_js_1 = requireSurrogatePairs();

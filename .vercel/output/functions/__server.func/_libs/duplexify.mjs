...
import { r as requireEndOfStream } from "./end-of-stream.mjs";
import { r as requireInherits } from "./inherits.mjs";
import { r as requireStreamShift } from "./stream-shift.mjs";
var duplexify;
...
function requireDuplexify() {
  ...
  var destroyer = function(self, end2) {
    return function(err) {
      ...
      else if (end2 && !self._ended) self.end();
    };
  };

...
function requireIndex_min() {
  ...
  var j = (c, t) => () => (t || c((t = { exports: {} }).exports, t), t.exports);
  var I = j((O) => {
  ...
  var g = I(), N = P(), C = () => g.metrics.hasSubscribers || g.tracing.hasSubscribers, k = /* @__PURE__ */ new Set(), G = typeof process == "object" && process ? process : {}, V = (c, t, e, i) => {
  ...
  var T = (c) => !!c && c === Math.floor(c) && c > 0 && isFinite(c), H = (c) => T(c) ? c <= Math.pow(2, 8) ? Uint8Array : c <= Math.pow(2, 16) ? Uint16Array : c <= Math.pow(2, 32) ? Uint32Array : c <= Number.MAX_SAFE_INTEGER ? W : null : null, W = class extends Array {
    ...
    static unsafeExposeInternals(t) {
      return { starts: t.#F, ttls: t.#d, autopurgeTimers: t.#g, sizes: t.#y, keyMap: t.#s, keyList: t.#i, valList: t.#t, next: t.#l, prev: t.#u, get head() {
        ...
        return t.#h;
      }, free: t.#_, isBackgroundFetch: (e) => t.#e(e), backgroundFetch: (e, i, s, n) => t.#G(e, i, s, n), moveToTail: (e) => t.#L(e), indexes: (e) => t.#A(e), rindexes: (e) => t.#z(e), isStale: (e) => t.#p(e) };
    }
    get max() {
      return this.#o;
    }
    ...
    *rvalues() {
    ...
    #G(t, e, i, s) {
      ...
      }, d = (f) => (i.status && (i.status.fetchRejected = true, i.status.fetchError = f), _(f, false)), _ = (f, b) => {
